...
\begin{tabular}{c c}
    \includegraphics[width=0.45\textwidth]{experimentOneApparatus} & \includegraphics[width=0.45\textwidth]{experimentOneDiagram}\\
	\textbf{Figure 3.1: Experiment 1} & \textbf{Figure 3.2: Experiment 1}\\
	\textbf{Apparatus} & \textbf{Diagram}
\end{tabular}

\begin{tabular}{c c}
    \includegraphics[width=0.45\textwidth]{experimentOneApparatus} & \includegraphics[width=0.45\textwidth]{experimentTwoDiagram}\\
	\textbf{Figure 3.3: Experiment 2} & \textbf{Figure 3.4: Experiment 2}\\
	\textbf{Apparatus} & \textbf{Diagram}
\end{tabular}

\begin{tabular}{c c}
\includegraphics[width=0.45\textwidth]{experimentThreeApparatus} &  \includegraphics[width=0.45\textwidth]{experimentThreeDiagram}\\
...
\begin{center}
    \includegraphics[width=0.75\textwidth]{experimentOne}\\
...
\end{center}
\begin{center}
    \includegraphics[width=0.75\textwidth]{experimentTwo}\\
...
\end{center}
\begin{center}
    \includegraphics[width=0.75\textwidth]{experimentThree}\\
...
% \textbf{Reciprocal error Propagation}\\
% Since the reciprocal of current over voltage is used to\\

% \textbf{Subtraction error propagation}\\
% Subtraction error propagation was used to calculate the result of the wire resistance in experiment 3. The following equation was used:
% $$u(a-b) = u(a) + u(b)$$
% Where $a$ and $b$ are measurements with uncertainty $u(a)$ and $u(b)$ respectively.
\end{document}
